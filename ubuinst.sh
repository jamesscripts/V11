...
wget https://raw.githubusercontent.com/jamesscripts/V11/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/jamesscripts/V11/main/install/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/jamesscripts/V11/main/install/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/jamesscripts/V11/main/install/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/jamesscripts/V11/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://www.dropbox.com/s/ijyrxu2xptbjzzi/gestorssh.zip > /dev/null 2>&1
...
echo -e "                              \033[1;31mModificado por @SuperNet\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/jamesscripts/V11/main/install/chave") &>/dev/null
