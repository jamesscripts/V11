...
wget -P /home https://raw.githubusercontent.com/jamesscripts/V11/main/install/verpweb > /dev/null 2>&1
[[ -f "/home/verpweb" ]] && {
...
wget -P /home https://raw.githubusercontent.com/jamesscripts/V11/main/install/verweb > /dev/null 2>&1
[[ -f "/home/verweb" ]] && {
